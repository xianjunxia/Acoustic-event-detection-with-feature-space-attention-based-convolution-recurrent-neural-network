...
from keras.layers import Bidirectional, TimeDistributed, Conv2D, MaxPooling2D, Input, GRU, Dense, Activation, Dropout, Reshape, Permute, Merge,merge
...
def get_model(data_in, data_out, _cnn_nb_filt, _cnn_pool_size, _rnn_nb, _fc_nb):
    ...
    '''
    inputss = Reshape((16*256,))(spec_x)    
    print(inputss.shape)
    attention_probs = Dense(4096, activation='relu', name='attention')(inputss)
    attention_probs = Dense(4096, activation='softmax', name='attention_vec')(attention_probs)
    attention_probs = BatchNormalization()(attention_probs)
    attention_probs = Dropout(0.2)(attention_probs)
    attention_mul = merge([inputss, attention_probs], output_shape = 16*256, name='attention_mul', mode='mul')   
...
def plot_functions(_nb_epoch, _tr_loss, _val_loss, _f1, _er, _f1_t,_er_t):
    ...
    plot.legend()
    plot.grid(True)
    plotname = '/data/users/21799506/Data/PRL2018/Evaluation/models_Noattention/performance.png'
...
for fold in [0]:
    directory = '/data/users/21799506/Data/PRL2018/Evaluation/models_Noattention'
    ...
    for i in range(nb_epoch):
        ...
        print(conf_mat)
        model_path =  '/data/users/21799506/Data/PRL2018/Evaluation/models_Noattention/model_' + str(i) + '.h5'
    ...
    lossname = '/data/users/21799506/Data/PRL2018/Evaluation/models_Noattention/performance'
